...
class Mailchimp
{
     ...
     */
    public function __construct(Client $client = null, $api_key = '', $api_user = 'apikey', $timeout = 10)
    {
    ...
    {
        return str_replace(Mailchimp::DEFAULT_DATA_CENTER, $this->getDataCenter(), $this->endpoint);
    }
    ...
    /**
     * Get the ID of the  data center associated with an API key.
     *
     * @param string $api_key
     *   The MailChimp API key.
     *
